            ...
            <tr  class="tableHeader">
                ...
                if(isset($_POST['submit'])){
                    ...
                    if($incID != "" || $incType != ""){
                        ...
                        if($res  == TRUE){
                            ...
                            if($count>0){
                              while($row = mysqli_fetch_assoc($res)){
                                ...
                                <td><a href="<?php echo SITEURL ?>updateIncidentU.php?id=<?php echo $incidentId?>"><i class="uil uil-edit icon editIcon"></i></a></td>
                                </tr>
                        ...
                        header('location:' .SITEURL. 'searcIncTypesU.php');
                        exit();
                    }
